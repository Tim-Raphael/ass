...
export class Ass {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Ass.prototype);
        obj.__wbg_ptr = ptr;
    ...
    * @returns {Ass}
    */
    static new(word_list, content) {
        const ptr0 = passArrayJsValueToWasm0(word_list, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayJsValueToWasm0(content, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.ass_new(ptr0, len0, ptr1, len1);
        return Ass.__wrap(ret);
    }
    /**
    * @param {number} count
    * @returns {Ass}
    */
    static new_random(count) {
        const ret = wasm.ass_new_random(count);
        return Ass.__wrap(ret);
    }
    /**
    * @param {number} count
    * @returns {(string)[]}
    */
    static random_items(count) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.ass_random_items(retptr, count);
    ...
    * @returns {(string)[]}
    */
    static random_content(count) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.ass_random_content(retptr, count);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var v1 = getArrayJsValueFromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 4, 4);
    ...
    */
    autocomplete(prefix) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.ass_autocomplete(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    get_content(item) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.ass_get_content(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred2_0 = r0;
            deferred2_1 = r1;
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('ass_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
